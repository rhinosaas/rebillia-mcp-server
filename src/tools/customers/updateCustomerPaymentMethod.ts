...
const definition = {
  ...
  description:
    "Update a payment method's billing address. PUT /customers/{customerId}/paymentmethods/{paymentMethodId}. Required: customerId, paymentMethodId, billingAddress (countryId, street1, city, state, zip). Optional: street2. Only billing address is updated.",
  inputSchema: {
...
export const updateCustomerPaymentMethodTool: Tool = {
  definition,
  handler,
};
